...
twitter_2020.update_layout(title="Twitter", width=995, height= 500)
...
facebook_2020.update_layout(title="Facebook", width=995, height= 500)
...
linkedin_2020.update_layout(title="LinkedIn", width=995, height= 500)
