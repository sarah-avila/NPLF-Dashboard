...
excel_file = 'NPLF LinkedIn Q2.xlsx'
#df = pd.read_excel(excel_file)

df = pd.read_excel('NPLF LinkedIn Q2.xlsx', sheet_name = [0,1,2,3,4])
df1 = pd.read_excel('NPLF LinkedIn Q2.xlsx', sheet_name = 'Company size')
df3 = pd.read_excel('NPLF LinkedIn Q2.xlsx', sheet_name = 'Update metrics (aggregated)')
df2 = pd.read_excel('NPLF LinkedIn Q2.xlsx', sheet_name = 'Industry')
df4 = pd.read_excel('NPLF LinkedIn Q2.xlsx', sheet_name = 'Seniority')
...
fig.update_layout(height= 3500, width= 1200, title_text="Linkedin Quarter 2")
